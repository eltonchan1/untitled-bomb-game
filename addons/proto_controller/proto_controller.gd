...
@export var input_left : String = "left_move"
## Name of Input Action to move Right.
@export var input_right : String = "right_move"
## Name of Input Action to move Forward.
@export var input_forward : String = "up_move"
## Name of Input Action to move Backward.
@export var input_back : String = "down_move"
